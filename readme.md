Реализация фронтенда интернет-магазина.
![alt text](1_start_1024.png)
![alt text](2_catalog_1300.png)
1.Верстка desktop
        tablet
        mobile
2.Загрузка товаров по ajax (Json сервер nodejs)
3.Фильтрация товаров
4.Поиск по товарам
5.Корзина CRUD(работа с localstorage)
6.Покупка товара
7.Бем труд и старания
